        ...
        <form @submit.prevent="submit">
            ...
            <div class="grid grid-cols-2 gap-0 items-stretch">
                ...
                <div class="space-y-6 px-8 py-8 border-r border-slate-200">
                    ...
                    <!-- Thème couleur -->
                    <div class="space-y-2">
                        <label class="text-sm font-semibold uppercase tracking-normal text-slate-400 mb-3 block">Couleur du thème</label>
                        <div class="flex items-center gap-2 flex-wrap" style="min-height: 44px">
                            <button
                                type="button"
                                @click="color = randomColor(color.value)"
                    ...
                    <div class="space-y-1.5">
                        <label class="text-sm font-semibold uppercase tracking-normal text-slate-400 mb-3 block">Choix des options</label>
                ...
                <div class="space-y-6 px-8 py-8">
                    ...
                    <div v-if="isEditing && poll?.secret_token" class="space-y-1.5">
                        <label class="text-sm font-semibold uppercase tracking-normal text-slate-400 mb-1.5 block">Lien de partage</label>
                    ...
                    <button
                        type="submit"
                        :disabled="loading"
                        class="w-full rounded-2xl bg-indigo-500 hover:bg-indigo-600 disabled:opacity-50
